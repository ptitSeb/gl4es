...
void glAlphaFunc(GLenum func, GLclampf ref) AliasExport("glshim_glAlphaFunc");
#endif
...
void glAlphaFuncx(GLenum func, GLclampx ref) AliasExport("glshim_glAlphaFuncx");
#endif
...
void glClear(GLbitfield mask) AliasExport("glshim_glClear");
#endif
...
void glClearColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) AliasExport("glshim_glClearColor");
#endif
...
void glClearColorx(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha) AliasExport("glshim_glClearColorx");
#endif
...
void glClearDepthf(GLclampf depth) AliasExport("glshim_glClearDepthf");
#endif
...
void glClearDepthx(GLclampx depth) AliasExport("glshim_glClearDepthx");
#endif
...
void glClearStencil(GLint s) AliasExport("glshim_glClearStencil");
#endif
...
void glClipPlanef(GLenum plane, const GLfloat * equation) AliasExport("glshim_glClipPlanef");
#endif
...
void glClipPlanex(GLenum plane, const GLfixed * equation) AliasExport("glshim_glClipPlanex");
#endif
...
void glColor4ub(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha) AliasExport("glshim_glColor4ub");
#endif
...
void glColor4x(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha) AliasExport("glshim_glColor4x");
#endif
...
void glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) AliasExport("glshim_glColorMask");
#endif
...
void glCullFace(GLenum mode) AliasExport("glshim_glCullFace");
#endif
...
void glDepthFunc(GLenum func) AliasExport("glshim_glDepthFunc");
#endif
...
void glDepthMask(GLboolean flag) AliasExport("glshim_glDepthMask");
#endif
...
void glDepthRangef(GLclampf near, GLclampf far) AliasExport("glshim_glDepthRangef");
#endif
...
void glDepthRangex(GLclampx near, GLclampx far) AliasExport("glshim_glDepthRangex");
#endif
...
void glDisableClientState(GLenum array) AliasExport("glshim_glDisableClientState");
#endif
...
void glEnableClientState(GLenum array) AliasExport("glshim_glEnableClientState");
#endif
...
void glFogf(GLenum pname, GLfloat param) AliasExport("glshim_glFogf");
#endif
#ifndef skip_glFogfv
...
void glFogx(GLenum pname, GLfixed param) AliasExport("glshim_glFogx");
#endif
#ifndef skip_glFogxv
...
void glFogxv(GLenum pname, const GLfixed * params) AliasExport("glshim_glFogxv");
#endif
...
void glFrontFace(GLenum mode) AliasExport("glshim_glFrontFace");
#endif
...
void glFrustumf(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far) AliasExport("glshim_glFrustumf");
#endif
...
void glFrustumx(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed near, GLfixed far) AliasExport("glshim_glFrustumx");
#endif
...
void glGetBooleanv(GLenum pname, GLboolean * params) AliasExport("glshim_glGetBooleanv");
#endif
...
void glGetBufferParameteriv(GLenum target, GLenum pname, GLint * params) AliasExport("glshim_glGetBufferParameteriv");
#endif
...
void glGetClipPlanef(GLenum plane, GLfloat * equation) AliasExport("glshim_glGetClipPlanef");
#endif
...
void glGetClipPlanex(GLenum plane, GLfixed * equation) AliasExport("glshim_glGetClipPlanex");
#endif
...
void glGetFixedv(GLenum pname, GLfixed * params) AliasExport("glshim_glGetFixedv");
#endif
...
void glGetLightfv(GLenum light, GLenum pname, GLfloat * params) AliasExport("glshim_glGetLightfv");
#endif
...
void glGetLightxv(GLenum light, GLenum pname, GLfixed * params) AliasExport("glshim_glGetLightxv");
#endif
...
void glGetMaterialfv(GLenum face, GLenum pname, GLfloat * params) AliasExport("glshim_glGetMaterialfv");
#endif
...
void glGetMaterialxv(GLenum face, GLenum pname, GLfixed * params) AliasExport("glshim_glGetMaterialxv");
#endif
...
void glGetTexEnvxv(GLenum target, GLenum pname, GLfixed * params) AliasExport("glshim_glGetTexEnvxv");
#endif
...
void glGetTexParameterfv(GLenum target, GLenum pname, GLfloat * params) AliasExport("glshim_glGetTexParameterfv");
#endif
...
void glGetTexParameteriv(GLenum target, GLenum pname, GLint * params) AliasExport("glshim_glGetTexParameteriv");
#endif
...
void glGetTexParameterxv(GLenum target, GLenum pname, GLfixed * params) AliasExport("glshim_glGetTexParameterxv");
#endif
#ifndef skip_glHint
...
void glHint(GLenum target, GLenum mode) AliasExport("glshim_glHint");
#endif
...
void glLightModelx(GLenum pname, GLfixed param) AliasExport("glshim_glLightModelx");
#endif
...
void glLightModelxv(GLenum pname, const GLfixed * params) AliasExport("glshim_glLightModelxv");
#endif
...
void glLightf(GLenum light, GLenum pname, GLfloat param) AliasExport("glshim_glLightf");
#endif
...
void glLightx(GLenum light, GLenum pname, GLfixed param) AliasExport("glshim_glLightx");
#endif
...
void glLightxv(GLenum light, GLenum pname, const GLfixed * params) AliasExport("glshim_glLightxv");
#endif
...
void glLineWidth(GLfloat width) AliasExport("glshim_glLineWidth");
#endif
...
void glLineWidthx(GLfixed width) AliasExport("glshim_glLineWidthx");
#endif
...
void glLoadIdentity() AliasExport("glshim_glLoadIdentity");
#endif
...
void glLoadMatrixx(const GLfixed * m) AliasExport("glshim_glLoadMatrixx");
#endif
...
void glLogicOp(GLenum opcode) AliasExport("glshim_glLogicOp");
#endif
...
void glMaterialf(GLenum face, GLenum pname, GLfloat param) AliasExport("glshim_glMaterialf");
#endif
...
void glMaterialx(GLenum face, GLenum pname, GLfixed param) AliasExport("glshim_glMaterialx");
#endif
...
void glMaterialxv(GLenum face, GLenum pname, const GLfixed * params) AliasExport("glshim_glMaterialxv");
#endif
...
void glMatrixMode(GLenum mode) AliasExport("glshim_glMatrixMode");
#endif
...
void glMultMatrixx(const GLfixed * m) AliasExport("glshim_glMultMatrixx");
#endif
...
void glMultiTexCoord4x(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q) AliasExport("glshim_glMultiTexCoord4x");
#endif
...
void glNormal3x(GLfixed nx, GLfixed ny, GLfixed nz) AliasExport("glshim_glNormal3x");
#endif
...
void glOrthof(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near, GLfloat far) AliasExport("glshim_glOrthof");
#endif
...
void glOrthox(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed near, GLfixed far) AliasExport("glshim_glOrthox");
#endif
...
void glPointParameterf(GLenum pname, GLfloat param) AliasExport("glshim_glPointParameterf");
#endif
...
void glPointParameterfv(GLenum pname, const GLfloat * params) AliasExport("glshim_glPointParameterfv");
#endif
...
void glPointParameterx(GLenum pname, GLfixed param) AliasExport("glshim_glPointParameterx");
#endif
...
void glPointParameterxv(GLenum pname, const GLfixed * params) AliasExport("glshim_glPointParameterxv");
#endif
...
void glPointSize(GLfloat size) AliasExport("glshim_glPointSize");
#endif
...
void glPointSizePointerOES(GLenum type, GLsizei stride, const GLvoid * pointer) AliasExport("glshim_glPointSizePointerOES");
#endif
...
void glPointSizex(GLfixed size) AliasExport("glshim_glPointSizex");
#endif
...
void glPolygonOffset(GLfloat factor, GLfloat units) AliasExport("glshim_glPolygonOffset");
#endif
...
void glPolygonOffsetx(GLfixed factor, GLfixed units) AliasExport("glshim_glPolygonOffsetx");
#endif
...
void glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid * pixels) AliasExport("glshim_glReadPixels");
#endif
...
void glRotatef(GLfloat angle, GLfloat x, GLfloat y, GLfloat z) AliasExport("glshim_glRotatef");
#endif
...
void glRotatex(GLfixed angle, GLfixed x, GLfixed y, GLfixed z) AliasExport("glshim_glRotatex");
#endif
...
void glSampleCoverage(GLclampf value, GLboolean invert) AliasExport("glshim_glSampleCoverage");
#endif
...
void glSampleCoveragex(GLclampx value, GLboolean invert) AliasExport("glshim_glSampleCoveragex");
#endif
...
void glScalef(GLfloat x, GLfloat y, GLfloat z) AliasExport("glshim_glScalef");
#endif
...
void glScalex(GLfixed x, GLfixed y, GLfixed z) AliasExport("glshim_glScalex");
#endif
...
void glScissor(GLint x, GLint y, GLsizei width, GLsizei height) AliasExport("glshim_glScissor");
#endif
...
void glShadeModel(GLenum mode) AliasExport("glshim_glShadeModel");
#endif
...
void glStencilFunc(GLenum func, GLint ref, GLuint mask) AliasExport("glshim_glStencilFunc");
#endif
...
void glStencilMask(GLuint mask) AliasExport("glshim_glStencilMask");
#endif
...
void glStencilOp(GLenum fail, GLenum zfail, GLenum zpass) AliasExport("glshim_glStencilOp");
#endif
...
void glTexEnvfv(GLenum target, GLenum pname, const GLfloat * params) AliasExport("glshim_glTexEnvfv");
#endif
...
void glTexEnviv(GLenum target, GLenum pname, const GLint * params) AliasExport("glshim_glTexEnviv");
#endif
...
void glTexEnvx(GLenum target, GLenum pname, GLfixed param) AliasExport("glshim_glTexEnvx");
#endif
...
void glTexEnvxv(GLenum target, GLenum pname, const GLfixed * params) AliasExport("glshim_glTexEnvxv");
#endif
...
void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid * pixels) AliasExport("glshim_glTexImage2D");
#endif
...
void glTexParameterfv(GLenum target, GLenum pname, const GLfloat * params) AliasExport("glshim_glTexParameterfv");
#endif
...
void glTexParameteriv(GLenum target, GLenum pname, const GLint * params) AliasExport("glshim_glTexParameteriv");
#endif
...
void glTexParameterx(GLenum target, GLenum pname, GLfixed param) AliasExport("glshim_glTexParameterx");
#endif
...
void glTexParameterxv(GLenum target, GLenum pname, const GLfixed * params) AliasExport("glshim_glTexParameterxv");
#endif
...
void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * pixels) AliasExport("glshim_glTexSubImage2D");
#endif
...
void glTranslatef(GLfloat x, GLfloat y, GLfloat z) AliasExport("glshim_glTranslatef");
#endif
...
void glTranslatex(GLfixed x, GLfixed y, GLfixed z) AliasExport("glshim_glTranslatex");
#endif
