...
void glActiveTexture(GLenum texture) __attribute__((alias("gl4es_glActiveTexture")));
#endif
...
void glAttachShader(GLuint program, GLuint shader) __attribute__((alias("gl4es_glAttachShader")));
#endif
...
void glBindAttribLocation(GLuint program, GLuint index, const GLchar * name) __attribute__((alias("gl4es_glBindAttribLocation")));
#endif
...
void glBindBuffer(GLenum target, GLuint buffer) __attribute__((alias("gl4es_glBindBuffer")));
#endif
...
void glBindFramebuffer(GLenum target, GLuint framebuffer) __attribute__((alias("gl4es_glBindFramebuffer")));
#endif
...
void glBindRenderbuffer(GLenum target, GLuint renderbuffer) __attribute__((alias("gl4es_glBindRenderbuffer")));
#endif
...
void glBindTexture(GLenum target, GLuint texture) __attribute__((alias("gl4es_glBindTexture")));
#endif
...
void glBlendColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) __attribute__((alias("gl4es_glBlendColor")));
#endif
...
void glBlendEquation(GLenum mode) __attribute__((alias("gl4es_glBlendEquation")));
#endif
...
void glBlendEquationSeparate(GLenum modeRGB, GLenum modeA) __attribute__((alias("gl4es_glBlendEquationSeparate")));
#endif
...
void glBlendFunc(GLenum sfactor, GLenum dfactor) __attribute__((alias("gl4es_glBlendFunc")));
#endif
...
void glBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha) __attribute__((alias("gl4es_glBlendFuncSeparate")));
#endif
...
void glBufferData(GLenum target, GLsizeiptr size, const GLvoid * data, GLenum usage) __attribute__((alias("gl4es_glBufferData")));
#endif
...
void glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid * data) __attribute__((alias("gl4es_glBufferSubData")));
#endif
...
GLenum glCheckFramebufferStatus(GLenum target) __attribute__((alias("gl4es_glCheckFramebufferStatus")));
#endif
#ifndef skip_glClear
...
void glClear(GLbitfield mask) __attribute__((alias("gl4es_glClear")));
#endif
...
void glClearColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) __attribute__((alias("gl4es_glClearColor")));
#endif
...
void glClearDepthf(GLclampf depth) __attribute__((alias("gl4es_glClearDepthf")));
#endif
...
void glClearStencil(GLint s) __attribute__((alias("gl4es_glClearStencil")));
#endif
...
void glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) __attribute__((alias("gl4es_glColorMask")));
#endif
...
void glCompileShader(GLuint shader) __attribute__((alias("gl4es_glCompileShader")));
#endif
...
void glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid * data) __attribute__((alias("gl4es_glCompressedTexImage2D")));
#endif
...
void glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid * data) __attribute__((alias("gl4es_glCompressedTexSubImage2D")));
#endif
...
void glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) __attribute__((alias("gl4es_glCopyTexImage2D")));
#endif
...
void glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) __attribute__((alias("gl4es_glCopyTexSubImage2D")));
#endif
...
GLuint glCreateProgram() __attribute__((alias("gl4es_glCreateProgram")));
#endif
...
GLuint glCreateShader(GLenum type) __attribute__((alias("gl4es_glCreateShader")));
#endif
...
void glCullFace(GLenum mode) __attribute__((alias("gl4es_glCullFace")));
#endif
...
void glDeleteBuffers(GLsizei n, const GLuint * buffer) __attribute__((alias("gl4es_glDeleteBuffers")));
#endif
#ifndef skip_glDeleteFramebuffers
void gl4es_glDeleteFramebuffers(GLsizei n, const GLuint * framebuffers) {
...
void glDeleteFramebuffers(GLsizei n, const GLuint * framebuffers) __attribute__((alias("gl4es_glDeleteFramebuffers")));
#endif
...
void glDeleteProgram(GLuint program) __attribute__((alias("gl4es_glDeleteProgram")));
#endif
#ifndef skip_glDeleteRenderbuffers
void gl4es_glDeleteRenderbuffers(GLsizei n, const GLuint * renderbuffers) {
...
void glDeleteRenderbuffers(GLsizei n, const GLuint * renderbuffers) __attribute__((alias("gl4es_glDeleteRenderbuffers")));
#endif
...
void glDeleteShader(GLuint program) __attribute__((alias("gl4es_glDeleteShader")));
#endif
...
void glDeleteTextures(GLsizei n, const GLuint * textures) __attribute__((alias("gl4es_glDeleteTextures")));
#endif
...
void glDepthFunc(GLenum func) __attribute__((alias("gl4es_glDepthFunc")));
#endif
...
void glDepthMask(GLboolean flag) __attribute__((alias("gl4es_glDepthMask")));
#endif
#ifndef skip_glDepthRangef
void gl4es_glDepthRangef(GLclampf zNear, GLclampf zFar) {
...
void glDepthRangef(GLclampf zNear, GLclampf zFar) __attribute__((alias("gl4es_glDepthRangef")));
#endif
...
void glDetachShader(GLuint program, GLuint shader) __attribute__((alias("gl4es_glDetachShader")));
#endif
...
void glDisable(GLenum cap) __attribute__((alias("gl4es_glDisable")));
#endif
...
void glDisableVertexAttribArray(GLuint index) __attribute__((alias("gl4es_glDisableVertexAttribArray")));
#endif
...
void glDrawArrays(GLenum mode, GLint first, GLsizei count) __attribute__((alias("gl4es_glDrawArrays")));
#endif
...
void glDrawElements(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices) __attribute__((alias("gl4es_glDrawElements")));
#endif
...
void glEnable(GLenum cap) __attribute__((alias("gl4es_glEnable")));
#endif
...
void glEnableVertexAttribArray(GLuint index) __attribute__((alias("gl4es_glEnableVertexAttribArray")));
#endif
...
void glFinish() __attribute__((alias("gl4es_glFinish")));
#endif
#ifndef skip_glFlush
void gl4es_glFlush() {
    LOAD_GLES(glFlush);
...
void glFlush() __attribute__((alias("gl4es_glFlush")));
#endif
...
void glFramebufferRenderbuffer(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer) __attribute__((alias("gl4es_glFramebufferRenderbuffer")));
#endif
...
void glFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) __attribute__((alias("gl4es_glFramebufferTexture2D")));
#endif
...
void glFrontFace(GLenum mode) __attribute__((alias("gl4es_glFrontFace")));
#endif
...
void glGenBuffers(GLsizei n, GLuint * buffer) __attribute__((alias("gl4es_glGenBuffers")));
#endif
#ifndef skip_glGenFramebuffers
void gl4es_glGenFramebuffers(GLsizei n, GLuint * framebuffers) {
...
void glGenFramebuffers(GLsizei n, GLuint * framebuffers) __attribute__((alias("gl4es_glGenFramebuffers")));
#endif
...
void glGenRenderbuffers(GLsizei n, GLuint * renderbuffers) __attribute__((alias("gl4es_glGenRenderbuffers")));
#endif
...
void glGenTextures(GLsizei n, GLuint * textures) __attribute__((alias("gl4es_glGenTextures")));
#endif
...
void glGenerateMipmap(GLenum target) __attribute__((alias("gl4es_glGenerateMipmap")));
#endif
...
void glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name) __attribute__((alias("gl4es_glGetActiveAttrib")));
#endif
...
void glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLint * size, GLenum * type, GLchar * name) __attribute__((alias("gl4es_glGetActiveUniform")));
#endif
...
void glGetAttachedShaders(GLuint program, GLsizei maxCount, GLsizei * count, GLuint * obj) __attribute__((alias("gl4es_glGetAttachedShaders")));
#endif
...
GLint glGetAttribLocation(GLuint program, const GLchar * name) __attribute__((alias("gl4es_glGetAttribLocation")));
#endif
...
void glGetBooleanv(GLenum pname, GLboolean * params) __attribute__((alias("gl4es_glGetBooleanv")));
#endif
...
void glGetBufferParameteriv(GLenum target, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetBufferParameteriv")));
#endif
...
GLenum glGetError() __attribute__((alias("gl4es_glGetError")));
#endif
...
void glGetFloatv(GLenum pname, GLfloat * params) __attribute__((alias("gl4es_glGetFloatv")));
#endif
...
void glGetFramebufferAttachmentParameteriv(GLenum target, GLenum attachment, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetFramebufferAttachmentParameteriv")));
#endif
...
void glGetIntegerv(GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetIntegerv")));
#endif
...
void glGetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei * length, GLchar * infoLog) __attribute__((alias("gl4es_glGetProgramInfoLog")));
#endif
...
void glGetProgramiv(GLuint program, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetProgramiv")));
#endif
...
void glGetRenderbufferParameteriv(GLenum target, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetRenderbufferParameteriv")));
#endif
...
void glGetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog) __attribute__((alias("gl4es_glGetShaderInfoLog")));
#endif
...
void glGetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision) __attribute__((alias("gl4es_glGetShaderPrecisionFormat")));
#endif
...
void glGetShaderSource(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * source) __attribute__((alias("gl4es_glGetShaderSource")));
#endif
...
void glGetShaderiv(GLuint shader, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetShaderiv")));
#endif
...
const GLubyte * glGetString(GLenum name) __attribute__((alias("gl4es_glGetString")));
#endif
...
void glGetTexParameterfv(GLenum target, GLenum pname, GLfloat * params) __attribute__((alias("gl4es_glGetTexParameterfv")));
#endif
...
void glGetTexParameteriv(GLenum target, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetTexParameteriv")));
#endif
...
GLint glGetUniformLocation(GLuint program, const GLchar * name) __attribute__((alias("gl4es_glGetUniformLocation")));
#endif
...
void glGetUniformfv(GLuint program, GLint location, GLfloat * params) __attribute__((alias("gl4es_glGetUniformfv")));
#endif
...
void glGetUniformiv(GLuint program, GLint location, GLint * params) __attribute__((alias("gl4es_glGetUniformiv")));
#endif
...
void glGetVertexAttribPointerv(GLuint index, GLenum pname, GLvoid ** pointer) __attribute__((alias("gl4es_glGetVertexAttribPointerv")));
#endif
...
void glGetVertexAttribfv(GLuint index, GLenum pname, GLfloat * params) __attribute__((alias("gl4es_glGetVertexAttribfv")));
#endif
...
void glGetVertexAttribiv(GLuint index, GLenum pname, GLint * params) __attribute__((alias("gl4es_glGetVertexAttribiv")));
#endif
#ifndef skip_glHint
...
void glHint(GLenum target, GLenum mode) __attribute__((alias("gl4es_glHint")));
#endif
...
GLboolean glIsBuffer(GLuint buffer) __attribute__((alias("gl4es_glIsBuffer")));
#endif
...
GLboolean glIsEnabled(GLenum cap) __attribute__((alias("gl4es_glIsEnabled")));
#endif
...
GLboolean glIsFramebuffer(GLuint framebuffer) __attribute__((alias("gl4es_glIsFramebuffer")));
#endif
...
GLboolean glIsProgram(GLuint program) __attribute__((alias("gl4es_glIsProgram")));
#endif
...
GLboolean glIsRenderbuffer(GLuint renderbuffer) __attribute__((alias("gl4es_glIsRenderbuffer")));
#endif
...
GLboolean glIsShader(GLuint shader) __attribute__((alias("gl4es_glIsShader")));
#endif
...
GLboolean glIsTexture(GLuint texture) __attribute__((alias("gl4es_glIsTexture")));
#endif
...
void glLineWidth(GLfloat width) __attribute__((alias("gl4es_glLineWidth")));
#endif
...
void glLinkProgram(GLuint program) __attribute__((alias("gl4es_glLinkProgram")));
#endif
...
void glPixelStorei(GLenum pname, GLint param) __attribute__((alias("gl4es_glPixelStorei")));
#endif
...
void glPolygonOffset(GLfloat factor, GLfloat units) __attribute__((alias("gl4es_glPolygonOffset")));
#endif
...
void glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid * pixels) __attribute__((alias("gl4es_glReadPixels")));
#endif
...
void glReleaseShaderCompiler() __attribute__((alias("gl4es_glReleaseShaderCompiler")));
#endif
...
void glRenderbufferStorage(GLenum target, GLenum internalformat, GLsizei width, GLsizei height) __attribute__((alias("gl4es_glRenderbufferStorage")));
#endif
...
void glSampleCoverage(GLclampf value, GLboolean invert) __attribute__((alias("gl4es_glSampleCoverage")));
#endif
...
void glScissor(GLint x, GLint y, GLsizei width, GLsizei height) __attribute__((alias("gl4es_glScissor")));
#endif
...
void glShaderBinary(GLsizei n, const GLuint * shaders, GLenum binaryformat, const GLvoid * binary, GLsizei length) __attribute__((alias("gl4es_glShaderBinary")));
#endif
...
void glShaderSource(GLuint shader, GLsizei count, const GLchar * const * string, const GLint * length) __attribute__((alias("gl4es_glShaderSource")));
#endif
...
void glStencilFunc(GLenum func, GLint ref, GLuint mask) __attribute__((alias("gl4es_glStencilFunc")));
#endif
...
void glStencilFuncSeparate(GLenum face, GLenum func, GLint ref, GLuint mask) __attribute__((alias("gl4es_glStencilFuncSeparate")));
#endif
...
void glStencilMask(GLuint mask) __attribute__((alias("gl4es_glStencilMask")));
#endif
...
void glStencilMaskSeparate(GLenum face, GLuint mask) __attribute__((alias("gl4es_glStencilMaskSeparate")));
#endif
...
void glStencilOp(GLenum fail, GLenum zfail, GLenum zpass) __attribute__((alias("gl4es_glStencilOp")));
#endif
...
void glStencilOpSeparate(GLenum face, GLenum sfail, GLenum zfail, GLenum zpass) __attribute__((alias("gl4es_glStencilOpSeparate")));
#endif
...
void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid * pixels) __attribute__((alias("gl4es_glTexImage2D")));
#endif
...
void glTexParameterf(GLenum target, GLenum pname, GLfloat param) __attribute__((alias("gl4es_glTexParameterf")));
#endif
...
void glTexParameterfv(GLenum target, GLenum pname, const GLfloat * params) __attribute__((alias("gl4es_glTexParameterfv")));
#endif
...
void glTexParameteri(GLenum target, GLenum pname, GLint param) __attribute__((alias("gl4es_glTexParameteri")));
#endif
...
void glTexParameteriv(GLenum target, GLenum pname, const GLint * params) __attribute__((alias("gl4es_glTexParameteriv")));
#endif
...
void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * pixels) __attribute__((alias("gl4es_glTexSubImage2D")));
#endif
...
void glUniform1f(GLint location, GLfloat v0) __attribute__((alias("gl4es_glUniform1f")));
#endif
...
void glUniform1fv(GLint location, GLsizei count, const GLfloat * value) __attribute__((alias("gl4es_glUniform1fv")));
#endif
...
void glUniform1i(GLint location, GLint v0) __attribute__((alias("gl4es_glUniform1i")));
#endif
...
void glUniform1iv(GLint location, GLsizei count, const GLint * value) __attribute__((alias("gl4es_glUniform1iv")));
#endif
...
void glUniform2f(GLint location, GLfloat v0, GLfloat v1) __attribute__((alias("gl4es_glUniform2f")));
#endif
...
void glUniform2fv(GLint location, GLsizei count, const GLfloat * value) __attribute__((alias("gl4es_glUniform2fv")));
#endif
...
void glUniform2i(GLint location, GLint v0, GLint v1) __attribute__((alias("gl4es_glUniform2i")));
#endif
...
void glUniform2iv(GLint location, GLsizei count, const GLint * value) __attribute__((alias("gl4es_glUniform2iv")));
#endif
...
void glUniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2) __attribute__((alias("gl4es_glUniform3f")));
#endif
...
void glUniform3fv(GLint location, GLsizei count, const GLfloat * value) __attribute__((alias("gl4es_glUniform3fv")));
#endif
...
void glUniform3i(GLint location, GLint v0, GLint v1, GLint v2) __attribute__((alias("gl4es_glUniform3i")));
#endif
...
void glUniform3iv(GLint location, GLsizei count, const GLint * value) __attribute__((alias("gl4es_glUniform3iv")));
#endif
...
void glUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) __attribute__((alias("gl4es_glUniform4f")));
#endif
...
void glUniform4fv(GLint location, GLsizei count, const GLfloat * value) __attribute__((alias("gl4es_glUniform4fv")));
#endif
...
void glUniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3) __attribute__((alias("gl4es_glUniform4i")));
#endif
...
void glUniform4iv(GLint location, GLsizei count, const GLint * value) __attribute__((alias("gl4es_glUniform4iv")));
#endif
...
void glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) __attribute__((alias("gl4es_glUniformMatrix2fv")));
#endif
...
void glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) __attribute__((alias("gl4es_glUniformMatrix3fv")));
#endif
...
void glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) __attribute__((alias("gl4es_glUniformMatrix4fv")));
#endif
...
void glUseProgram(GLuint program) __attribute__((alias("gl4es_glUseProgram")));
#endif
...
void glValidateProgram(GLuint program) __attribute__((alias("gl4es_glValidateProgram")));
#endif
...
void glVertexAttrib1f(GLuint index, GLfloat x) __attribute__((alias("gl4es_glVertexAttrib1f")));
#endif
...
void glVertexAttrib1fv(GLuint index, const GLfloat * v) __attribute__((alias("gl4es_glVertexAttrib1fv")));
#endif
...
void glVertexAttrib2f(GLuint index, GLfloat x, GLfloat y) __attribute__((alias("gl4es_glVertexAttrib2f")));
#endif
...
void glVertexAttrib2fv(GLuint index, const GLfloat * v) __attribute__((alias("gl4es_glVertexAttrib2fv")));
#endif
...
void glVertexAttrib3f(GLuint index, GLfloat x, GLfloat y, GLfloat z) __attribute__((alias("gl4es_glVertexAttrib3f")));
#endif
...
void glVertexAttrib3fv(GLuint index, const GLfloat * v) __attribute__((alias("gl4es_glVertexAttrib3fv")));
#endif
...
void glVertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) __attribute__((alias("gl4es_glVertexAttrib4f")));
#endif
...
void glVertexAttrib4fv(GLuint index, const GLfloat * v) __attribute__((alias("gl4es_glVertexAttrib4fv")));
#endif
...
void glVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid * pointer) __attribute__((alias("gl4es_glVertexAttribPointer")));
#endif
...
void glViewport(GLint x, GLint y, GLsizei width, GLsizei height) __attribute__((alias("gl4es_glViewport")));
#endif
